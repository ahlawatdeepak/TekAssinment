   ...
   setData(output)
    ...
    return (
        ...
        <>
          ...
          <Box  margin='auto' mt='20px'>
              <Link to='/'><Button>Go to Home page</Button></Link>
          </Box>
         
          <Heading mt='20px' mb='30px' size='md'>Click to Upload CSV file and get it with calculated tax values</Heading>
            ...
            >
              {acceptedFile ? (
                <>
                  ...
                  <Button cursor='pointer'>Upload CSV file</Button>   // onclick on this button the file should be uploded
              )}
            </div>
          </>
        )} 
